(function(){
  ...
  */
  ...
  function closeCustomize(){if(!customizeOpen)return;customizeOpen=false;if(customizeHowl){try{customizeHowl.stop();customizeHowl.unload()}catch(e){}customizeHowl=null}try{q.hasAModal=false}catch(e){}if(customizeScene)try{customizeScene.F6(5,1,0,350)}catch(e){}if(customizeBg)try{customizeBg.F6(5,1,0,350)}catch(e){}setTimeout(function(){try{if(customizeScene){customizeScene.e1();var i=q.children.indexOf(customizeScene);if(i>=0)q.children.splice(i,1)}}catch(e){}try{if(customizeBg){var j=q.children.indexOf(customizeBg);if(j>=0)q.children.splice(j,1)}}catch(e){}customizeScene=null;customizeBg=null;customizePlayer=null;try{q.InitTitleScreen()}catch(e){}},380)}
  function openCustomize(){if(customizeOpen)return;customizeOpen=true;patchHue();var GS=window.DiggerzRuntime.getGameSettings(),old=q.GetChildByType(GS);if(old)try{old.F6(5,1,0,300)}catch(e){}if(typeof Howl!=='undefined'){customizeHowl=new Howl({src:['/music_theme3.ogg'],loop:true,volume:.7,preload:true});customizeHowl.play()}customizeBg=z.I9();customizeBg.Init(f.B273_0_PNG());customizeBg.A7=q.CENTERX;customizeBg.A8=q.CENTERY;customizeBg.set_local_xScale((q.SCREENWIDTH+80)/customizeBg._5.width);customizeBg.set_local_yScale((q.SCREENHEIGHT+80)/customizeBg._5.height);customizeBg.B8=-999;customizeBg.set_local_alp(0);q.children.splice(0,0,customizeBg);customizeBg.F6(5,0,1,350);customizeScene=new ja(700,700,true);customizeScene.A7=q.CENTERX;customizeScene.A8=q.CENTERY;var cs=Math.min(1,(q.SCREENWIDTH-20)/700,(q.SCREENHEIGHT-20)/700);customizeScene.set_local_xScale(cs);customizeScene.set_local_yScale(cs);customizeScene.set_alp(0);q.children.push(customizeScene);customizeScene.F6(5,0,1,450);text(customizeScene,0,-315,'Customize',q.MAIN_FONT_BIG,1.05);var x=new yo(customizeScene);x.b6=-315;x.b7=-320;x.C33=closeCustomize;customizeScene._9.push(x);text(customizeScene,-170,-300,'YOUR CHARACTER',q.MAIN_FONT_SMALL,.78);makePreview(customizeScene);text(customizeScene,175,-300,'CLOTHING',q.MAIN_FONT_SMALL,.78);customizeClothing=z.I9();customizeClothing.D7(customizeScene);customizeClothing.b6=175;customizeClothing.b7=-15;customizeClothing.set_local_alp(.85);customizeScene._9.push(customizeClothing);buildClothes();text(customizeScene,-170,165,'Skin Tone',q.MAIN_FONT_BIG,.62);customizeSkinSlider=new vl(customizeScene,-170,195,300,42,2,f.HEAD_PNG(),Th.n7(),null,q.player.l9);customizeSkinSlider.b6=-170;customizeSkinSlider.b7=195;customizeSkinSlider.d49.set_alp(0);customizeSkinSlider.D45=function(){q.player.l9=Math.max(.01,customizeSkinSlider.D43);q.SaveGlobals();refreshPreview()};customizeScene._9.push(customizeSkinSlider);text(customizeScene,-170,245,'Skin Hue',q.MAIN_FONT_BIG,.62);customizeHueSlider=new vl(customizeScene,-170,275,300,42,2,f.HEAD_PNG(),Th.n7(),null,customizeHue/3.6);customizeHueSlider.b6=-170;customizeHueSlider.b7=275;customizeHueSlider.d49.set_alp(0);customizeHueSlider.D45=function(){setHue(customizeHueSlider.D43*3.6);refreshPreview()};customizeScene._9.push(customizeHueSlider);text(customizeScene,175,165,'Country',q.MAIN_FONT_BIG,.62);customizeCountry=z.I9();customizeCountry.D7(customizeScene);customizeCountry.b6=175;customizeCountry.b7=225;customizeCountry.set_local_alp(.9);customizeScene._9.push(customizeCountry);buildCountries();text(customizeScene,175,365,'Click clothing to equip it.',q.MAIN_FONT_SMALL,.65);try{q.hasAModal=true}catch(e){}}
  ...
  function install(){
    ...
    patchHue();
    try{var GS=window.DiggerzRuntime.getGameSettings();if(GS&&!GS.prototype.__c237){var oc=GS.prototype._56;GS.prototype._56=function(){try{if(oc)oc.call(this)}catch(e){};openCustomize()};GS.prototype.__c237=true}}catch(e){}
